...
| `guac.ociCollector.resources.requests.cpu`                     |                                                                                              | `0.2`                                                  |
| `guac.ociCollector.resources.requests.memory`                  |                                                                                              | `300M`                                                 |
...
| `guac.depsDevCollector.resources.requests.cpu`                 |                                                                                              | `0.2`                                                  |
| `guac.depsDevCollector.resources.requests.memory`              |                                                                                              | `300M`                                                 |
...
| `guac.osvCertifier.resources.requests.cpu`                     |                                                                                              | `0.2`                                                  |
| `guac.osvCertifier.resources.requests.memory`                  |                                                                                              | `300M`                                                 |
...
| `guac.ingestor.resources.requests.cpu`                         |                                                                                              | `0.2`                                                  |
| `guac.ingestor.resources.requests.memory`                      |                                                                                              | `300M`                                                 |
...
| `guac.collectSub.resources.requests.cpu`                       |                                                                                              | `0.2`                                                  |
| `guac.collectSub.resources.requests.memory`                    |                                                                                              | `300M`                                                 |
...
| `guac.graphqlServer.resources.requests.cpu`                    |                                                                                              | `0.2`                                                  |
| `guac.graphqlServer.resources.requests.memory`                 |                                                                                              | `300M`                                                 |
