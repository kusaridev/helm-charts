...
| `guac.ociCollector.image.repository`                           | Path to the OCI Collector image                                                         | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.ociCollector.image.command`                              | Command for the OCI Collector image.  It is not recommended to override this.           | `["sh","-c","/cnb/process/guaccollect image --use-csub"]`    |
...
| `guac.depsDevCollector.image.repository`                       | Path to the Deps.Dev Collector image                                                    | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.depsDevCollector.image.command`                          | Command for the Deps.Dev Collector image.  It is not recommended to override this.      | `["sh","-c","/cnb/process/guaccollect deps_dev --use-csub"]` |
...
| `guac.osvCertifier.image.repository`                           | Path to the OSV Certifier Collector image                                               | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.osvCertifier.image.command`                              | Command for the OSV Certifier Collector image.  It is not recommended to override this. | `["sh","-c","/cnb/process/guacone osv --poll --interval 5"]` |
...
| `guac.ingestor.image.repository`                               | Path to the Ingestor image                                                              | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.collectSub.image.repository`                             | Path to the Collector Sub image                                                         | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.graphqlServer.image.repository`                          | Path to the GraphQL Server image                                                        | `ghcr.io/kusaridev/guac`                                     |
...
| `guac.graphqlServer.image.command`                             | Command for the GraphQL Server image.  It is not recommended to override this.          | `["sh","-c","/cnb/process/guacgql --gql-debug"]`             |
...
| `guac.graphqlServer.debug`                                     | Enable debug mode for graphql server; also enable the UI                                | `false`                                                      |
